...
//árvore alvinegra de games
class AlvinegraGames {
    private NoAN raiz;

    public AlvinegraGames() {
        raiz = null;
    }
    ...
    public void inserir(Game elemento) {
        if (raiz == null) {
            ...
            } else if (elemento.getName().compareTo(raiz.dir.elemento.getName()) < 0) { //dir
            ...
            } else if (elemento.getName().compareTo(raiz.esq.elemento.getName()) > 0) { //esq 
    ...
    //Metódo privado para inserir 
    private void inserir(Game elemento, NoAN bisavo, NoAN avo, NoAN pai, NoAN i) {
        if (i == null) {
    ...
    private int pesquisar(NoAN i, String nome, int comp){
        NoAN temp = i;
        if(temp == null) {
            comp = comp + 1;
            System.out.printf("NAO\n");
        } else if(nome.compareTo(temp.elemento.getName()) == 0) {
            comp = comp + 1;
...
public class TP07Q04 {
    public static void main(String[] args) throws Exception {
        ...
        AlvinegraGames arvore = new AlvinegraGames();
        ...
        escreverLog("874398_arvoreAlvinegra(Galo).txt", comp, (fim-inicio)/1000.0);
