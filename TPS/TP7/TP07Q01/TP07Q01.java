...
class ArvoreBinariaGames {
    ...
    private int pesquisar(No i, String nome, int comp){
        No temp = i;
        if(temp == null) {
            comp = comp + 1;
...
public class TP07Q01 {
    public static void main(String[] args) throws Exception {
        ...
        escreverLog("874398_arvoreBinaria.txt", comp, (fim-inicio)/1000.0);
